...
def analytics_tables(bucket, dataframe, table_name, flag_write_redshift, url_jdbc): ##This step usually come after, cause it's analytics refined step
...
# Ler dados da raw
df = read_csv('s3a://raw-bucket-de','public/tb_coins/')
...
write_processed("s3a://processed-bucket-de","tb_coins","year","delta","overwrite")

# Ler dados da processed e escrever na camada curated.
df = read_delta("s3a://processed-bucket-de","tb_coins")

flag_write_redshift = True ## True quando o redsfhit estiver em funcionamento
url_jdbc = "jdbc:redshift://redshift-cluster-1.cufcxu0ztur8.us-east-1.redshift.amazonaws.com:5439/dev"
analytics_tables("s3a://refined-bucket-de",df,"tb_coins", flag_write_redshift, url_jdbc)
